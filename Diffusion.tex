...
In der Abb. \ref{fig:diffkurvetheo} ist zudem zu erkennen, dass bei einer Diffusionskonstante von $4\cdot 10^{-10}$m$^2$/s auch nach zwei Tagen immernoch ein deutlicher Gradient zu erkennen ist.\\\\
...
\end{figure}
Für die beiden Messungen haben wir 14min und 16min benötigt.
Dies ist \newpage
\section{Diskussion}
...
Desweiteren ist darauf zu achten, das Licht im Raum möglichst stark zu dimmen, da uns auffiel, dass das Öffnen der Tür und damit ein Lichteinfall unser Voltmeter hat ausschlagen lassen.
