...
Dabei ist darauf zu achten, dass alle Konzentrationen mit dem Aufbau geeicht werden können.
\subsection{Messung 1}
\label{sec:messung1}
Für Messung 1 wird der verstellbare Wiederstand solange angepasst, bis das das 
