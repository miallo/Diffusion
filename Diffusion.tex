...
Die so entstehenden zufälligen Bewegungen wurden schon 1827 entdeckt \cite[S. 8]{demtroeder}
...
\vec j(\vec x)=-D ~ \nabla n
\end{align}
Hierbei ist D die Diffusionskonstante, welche festlegt, wie groß der Teilchenstrom ist.
...
\end{figure}
Die Steigung der gefitteten Geraden von Messung 1 aus Abb. \ref{fig:M12} beträgt $(1.63\pm 0.03)\cdot 10^{-9}$m$^2$/s und die von Messung 2 $(3.54\pm 0.09)\cdot 10^{-9}$m$^2$/s
