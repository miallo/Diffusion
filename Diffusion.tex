...
$$\shadowbox{$D=(3.0\pm 0.1)\cdot 10^{-10}\text{m}^2/\text{s}$}$$
 Dies stimmt nicht ganz mit dem im Praktikumshandbuch vorgeschlagenen Wert von $D=4.0\cdot 10^{-10}\text{m}^2/\text{s}$ überein.
\begin{figure}[!h]
\centering
\input{v1ges.tex}
